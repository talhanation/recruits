...
public final class WorldMapRegionStorage {
    ...
    private static final int PIXEL_COUNT =
            WorldMapRegion.REGION_PIXEL_SIZE * WorldMapRegion.REGION_PIXEL_SIZE;
    ...
    public static void write(File file, WorldMapRegionPixels.Snapshot pixels) throws IOException {
        if (pixels == null) {
    ...
    private static void write(File file, PixelWriter pixelWriter) throws IOException {
        ...
        buffer.putInt(WorldMapRegion.REGION_PIXEL_SIZE);
        buffer.putInt(WorldMapRegion.REGION_PIXEL_SIZE);
    ...
    private static ReadResult readData(File file) {
        ...
        if (buffer.getInt() != MAGIC
                ...
                || buffer.getInt() != WorldMapRegion.REGION_PIXEL_SIZE
                || buffer.getInt() != WorldMapRegion.REGION_PIXEL_SIZE
