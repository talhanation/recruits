...
public class DebugInvScreen extends ScreenBase<DebugInvMenu> {
    ...
    private void xpButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 0, 40, 20, new TextComponent("+xp"), button -> {
                Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(0, recruit.getUUID(), textField.getValue()));
        }));
        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 0, 40, 20, new TextComponent("+10xp"), button -> {
    ...
    private void lvlButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 1, 40, 20, new TextComponent("+lvl"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(1, recruit.getUUID(), textField.getValue()));
        }));
        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 1, 40, 20, new TextComponent("+5lvl"), button -> {
    ...
    private void hungerButton(int zeroLeftPos, int zeroTopPos){
        ...
        //decrease hunger
        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 3, 40, 20, new TextComponent("-hunger"), button -> {
    ...
    private void moralButton(int zeroLeftPos, int zeroTopPos){
        //increase moral
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 4, 40, 20, new TextComponent("+morale"), button -> {

            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(6, recruit.getUUID(), textField.getValue()));
        }));

        //decrease moral
        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 4, 40, 20, new TextComponent("-morale"), button -> {
    ...
    private void healthButton(int zeroLeftPos, int zeroTopPos){
        //increase health
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 5, 40, 20, new TextComponent("+health"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(8, recruit.getUUID(), textField.getValue()));
        }));

        //decrease health
        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 5, 40, 20, new TextComponent("-health"), button -> {
    ...
    private void variantButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 6, 40, 20, new TextComponent("+variant"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(10, recruit.getUUID(), textField.getValue()));
        }));

        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 6, 40, 20, new TextComponent("-variant"), button -> {
    ...
    private void biomeButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 7, 40, 20, new TextComponent("+biome"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(12, recruit.getUUID(), textField.getValue()));
        }));

        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 7, 40, 20, new TextComponent("-biome"), button -> {
    ...
    private void teamColorButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos - 210, zeroTopPos + (20 + 5) * 8, 40, 20, new TextComponent("+tcolor"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(24, recruit.getUUID(), textField.getValue()));
        }));

        addRenderableWidget(new Button(zeroLeftPos - 160, zeroTopPos + (20 + 5) * 8, 40, 20, new TextComponent("-tcolor"), button -> {
    ...
    private void killHealButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos + 130, zeroTopPos + (20 + 5) * 2, 40, 20, new TextComponent("heal"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(14, recruit.getUUID(), textField.getValue()));
        }));

        addRenderableWidget(new Button(zeroLeftPos + 80, zeroTopPos + (20 + 5) * 2, 40, 20, new TextComponent("-kill"), button -> {
    ...
    private void clearButton(int zeroLeftPos, int zeroTopPos) {
        addRenderableWidget(new Button(zeroLeftPos + 130, zeroTopPos + (20 + 5) * 3, 40, 20, new TextComponent("c upkeep"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(16, recruit.getUUID(), textField.getValue()));
        }));

        addRenderableWidget(new Button(zeroLeftPos + 80, zeroTopPos + (20 + 5) * 3, 40, 20, new TextComponent("c hold"), button -> {
    ...
    private void clearButton2(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos + 130, zeroTopPos + (20 + 5) * 4, 40, 20, new TextComponent("c prot"), button -> {
            Main.SIMPLE_CHANNEL.sendToServer(new MessageDebugGui(18, recruit.getUUID(), textField.getValue()));
        }));

        addRenderableWidget(new Button(zeroLeftPos + 80, zeroTopPos + (20 + 5) * 4, 40, 20, new TextComponent("c mount"), button -> {
    ...
    private void promoteButton(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos + 80, zeroTopPos + (20 + 5) * 5, 40, 20, new TextComponent("pro"), button -> {
    ...
    private void clearTeam(int zeroLeftPos, int zeroTopPos){
        addRenderableWidget(new Button(zeroLeftPos + 80, zeroTopPos + (20 + 5) * 6, 40, 20, new TextComponent("c team"), button -> {
