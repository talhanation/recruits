...
public class PatrolLeaderScreen extends ScreenBase<PatrolLeaderContainer> {
    ...
    private void setNotificationButton(Component infoModeString) {
        Button infoButton = addRenderableWidget(new Button(leftPos + 216, topPos + 62, 50, 20, infoModeString, button -> {
    ...
    public void setCycleButton(Component cycle, Component tooltip) {
        Button cycleButton = addRenderableWidget(new Button(leftPos + 105, topPos + 11, 40, 20, cycle,
                button -> {
    ...
    public void setFastPatrollingButton(Component cycle) {
        Button buttonFastPatrolling = addRenderableWidget(new Button(leftPos + 216, topPos + 92, 50, 20, cycle,
                button -> {
    ...
    public void setStartButtons(Component start, Component tooltip) {
        Button startButton = addRenderableWidget(new Button(leftPos + 19, topPos + 11, 40, 20, start,
                ...
                (button, poseStack, i, i1) -> {
                    this.renderTooltip(poseStack, recruit instanceof CaptainEntity && !(recruit.getVehicle() instanceof Boat) ? TOOLTIP_DISABLED_START : tooltip, i, i1);
                }
        ));
    ...
    protected void renderLabels(PoseStack matrixStack, int mouseX, int mouseY) {
        ...
        font.draw(matrixStack, "z: ",  offset + 140, 42, fontColor);
        // Info
