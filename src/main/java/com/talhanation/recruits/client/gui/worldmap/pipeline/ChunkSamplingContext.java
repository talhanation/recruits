...
public final class ChunkSamplingContext {
    ...
    public static ChunkSamplingContext capture(
            ClientLevel level, int centerChunkX, int centerChunkZ) {
    ...
    public LevelChunk getLoadedChunk(int worldX, int worldZ) {
    ...
    public boolean belongsTo(ClientLevel currentLevel) {
