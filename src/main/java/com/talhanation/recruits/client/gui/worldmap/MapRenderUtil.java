...
final class MapRenderUtil {
    private MapRenderUtil() {
    }

    static void fill(GuiGraphics graphics, double x1, double y1, double x2, double y2, int color) {
    ...
    static void line(GuiGraphics graphics, double x1, double y1, double x2, double y2, double thickness, int color) {
        double dx = x2 - x1;
        double dy = y2 - y1;
