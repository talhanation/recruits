...
public final class MapReliefShading {
    ...
    public static float computeWaterBrightness(int shoreNeighbors, int depth, int relief) {
    ...
    public static ColorMultiplier computeLandBrightness(
            ClientLevel level, MapSample sample, int northHeight, int northWestHeight) {
