...
final class MapTerrainColorResolver {
    ...
    static int resolve(
        ...
        if (surface.isWaterLike()) {
            return MapBlockColorResolver.resolveWaterNativeColor(surface, underlay, waterNeighbors, waterRelief);
        }
        ...
        return MapBlockColorResolver.applyBrightnessToNativeColor(
                rgb,
                MapReliefShading.computeLandBrightness(level, surface, northHeight, northWestHeight)
        );
    }
    ...
    private static int resolveTransparentOverlay(
        ...
        int baseNative = resolve(
                level, underlay, null, northHeight, northWestHeight, waterNeighbors, waterRelief
        );
        ...
        int blendedRgb = MapBlockColorResolver.blendRgb(
                ...
                overlayRgb,
                MapStateSampler.getTransparentOverlayAlpha(overlay.state())
        );
