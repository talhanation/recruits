...
public class MessengerScreen extends RecruitsScreenBase {
    ...
    private void setButtons() {
        clearWidgets();
        this.textFieldMessage = new MultiLineEditBox(font, guiLeft + 3, guiTop + ySize - 203,  186, 150, new TextComponent(""), new TextComponent(""));
        ...
        if(playerInfo != null){
            this.selectedPlayerWidget = new SelectedPlayerWidget(font, guiLeft + 33, guiTop + ySize - 235, 128, 20, new TextComponent("x"), // Button label
                    () -> {
                        playerInfo = null;
