...
public class RecruitHorseModel extends EntityModel<RecruitHorseEntity> {
    ...
    protected void addEarModels(ModelPart p_199047_1_) {
    ...
    public void prepareMobModel(RecruitHorseEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        ...
        float f = Mth.rotlerp(p_212843_1_.yBodyRotO, p_212843_1_.yBodyRot, p_212843_4_);
        float f1 = Mth.rotlerp(p_212843_1_.yHeadRotO, p_212843_1_.yHeadRot, p_212843_4_);
        float f2 = Mth.lerp(p_212843_4_, p_212843_1_.xRotO, p_212843_1_.xRot);
        float f3 = f1 - f;
        ...
        if (p_212843_3_ > 0.2F) {
            f4 += Mth.cos(p_212843_2_ * 0.4F) * 0.15F * p_212843_3_;
        }
        ...
        float f10 = 1.0F;
        float f11 = Mth.cos(f10 * p_212843_2_ * 0.6662F + (float)Math.PI);
