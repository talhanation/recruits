...
public class MessengerHumanRenderer extends AbstractRecruitHumanRenderer<AbstractRecruitEntity> {
    ...
    public MessengerHumanRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
