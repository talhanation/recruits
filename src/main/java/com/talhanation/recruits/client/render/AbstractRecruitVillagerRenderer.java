...
public abstract class AbstractRecruitVillagerRenderer extends HumanoidMobRenderer<AbstractRecruitEntity, HumanoidModel<AbstractRecruitEntity>> {
    ...
    //PlayerRenderer
    private void setModelVisibilities(AbstractRecruitEntity recruitEntity) {
