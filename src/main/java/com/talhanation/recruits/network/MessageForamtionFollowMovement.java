...
public class MessageForamtionFollowMovement implements Message<MessageForamtionFollowMovement> {
    ...
    public MessageForamtionFollowMovement(){
    }

    public MessageForamtionFollowMovement(UUID player_uuid, int group, int formation) {
    ...
    public MessageForamtionFollowMovement fromBytes(FriendlyByteBuf buf) {
