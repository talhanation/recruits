...
public class RecruitsPathNodeEvaluator extends NodeEvaluator {
    ...
    protected @NotNull Node getNode(int x, int y, int z) {
        ...
        net.minecraft.world.level.block.Block below = this.level.getBlockState(pos.below()).getBlock();
        if (com.talhanation.recruits.config.RecruitsServerConfig.getPreferredPathBlocks().contains(below)) {
